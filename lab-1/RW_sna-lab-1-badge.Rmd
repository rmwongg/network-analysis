...
```{r}
year_3_collaboration<-read_excel("~/Documents/GitHub/network-analysis/lab-1/data/year_3_collaboration.xlsx", col_names = FALSE)
...
```{r}
collaborationmatrix <- as.matrix(year_3_collaboration)
collaborationmatrix

class(year_3_collaboration)
class(collaborationmatrix)

collaboration_network <- as_tbl_graph(year_3_collaboration, 
                                directed = TRUE)
collaboration_network
```

```{r}
collaboration_edges <- collaboration_network |>
  activate(edges) |>
  as_tibble()

collaboration_edges

collaboration_network <- tbl_graph(edges = collaboration_edges, # specifies edges
...
```{r}
collaboration_network <- tbl_graph(edges = collaboration_edges, 
                             nodes = student_attributes, 
                             directed = TRUE)

collaboration_network

plot(collaboration_network)
```
